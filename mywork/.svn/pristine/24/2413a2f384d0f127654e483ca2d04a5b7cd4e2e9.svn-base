...
class AdminPageClassManageAction extends AdminAction {
    ...
    public function formDelAdminPageClass(){
        ...
        $return = $CommonAdminPageclass->getAdminPageData($data);
        if($return === false){
            $this->error(L(strtoupper('ERROR_' . __CLASS__ . '_' . __FUNCTION__ . '_02')));
        }
        $data = array(
        ...
        $return = $CommonAdminPageclass->setAdminPageOrderByClassIdAndPageOrder($data);
        if($return === false){
            $this->error(L(strtoupper('ERROR_' . __CLASS__ . '_' . __FUNCTION__ . '_03')));
        }
        $data = array(
    ...
    public function formSortAgentPageClass(){
        ...
        $CommonAdminPageclass = D("CommonAdminPageclass");
        $return = $CommonAdminPageclass->setSortAgentPageClassOrder($data);
        redirect(__APP__.'/AdminPageClassManage/index');
    }
    //TODO: 開關AJAX
