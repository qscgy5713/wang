...
class AnnouncementManageAction extends AdminAction {
    ...
    public function index(){
        ...
        $this->assign("showEmpty","<tr><td colspan='11' align='center'>無資料</td></tr>");
        $this->display();
    }
    //TODO: 新增公告
    public function formAddAnnouncement(){
        ...
        $data = array(
            "announcement_belong" => $request['addBelong'],
            "announcement_title" => array_to_json($titleArray),
            "announcement_text" => array_to_json($textArray),
    ...
    public function formSetAnnouncement(){
        ...
        if(empty($return['announcement_belong']) && $return['announcement_belong'] !== '0'){
            $this->error(L(strtoupper('ERROR_' . __CLASS__ . '_' . __FUNCTION__ . '_04')));//修改的公告已被刪除，請重新選擇。
        }
        ...
        if($return === 1){
            ...
            $this->error(L(strtoupper('ERROR_' . __CLASS__ . '_' . __FUNCTION__ . '_08')));
        }
