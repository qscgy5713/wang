...
class ManageBankAction extends AdminAction {
    ...
    public function formSetMemberBank(){
        ...
        $addData = array(
            'operateLog_class'=>32, //
            'operateLog_objectId'=>$request['setMemberId'],
            'operateLog_objectAccount'=>$request['setMemberAcc'],
    ...
    public function formDelMemberBank(){
        ...
        $return = $CommonMemberBankdata->getMemberBankDataForLog($data);
        $addData = array(
            'operateLog_class'=>31, //刪除綁定
            'operateLog_objectId'=>$request['delMemberId'],
            'operateLog_objectAccount'=>$request['delAccount'],
            'operateLog_main'=> array(
                'bankdata_id' => $return['bankdata_id'],
                'member_id' => $return['member_id'],
                'bankdata_code' => $return['bankdata_code'],
                'bankdata_account' => $return['bankdata_account'],
                'bankdata_name' => $return['bankdata_name'],
                'bankdata_branch' => $return['bankdata_branch'],
                'bankdata_remark' => $return['bankdata_remark'],
            ),
        );
        $this->addAdminOperateLog($addData);
