                            ...
                            <table class="table table-striped m-b-0">
                                ...
                                <tbody>
                                    <?php if(is_array($showArray)): $i = 0; $__LIST__ = $showArray;if( count($__LIST__)==0 ) : echo "$showEmpty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td><?php echo ($vo["mainCode"]); ?></td>
                                            <td><?php echo ($vo["mainText"]); ?></td>
                                            <td>
                                                <a onclick="openmodal('setModal','<?php echo ($vo["mainCode"]); ?>','<?php echo ($vo["mainText"]); ?>')"><i class="fas fa-wrench fa-fw icon-size"></i></a>
                                                <form id="delform<?php echo ($vo["mainCode"]); ?>" class="div-style" method="post" action='__APP__/NewsletterPreset/delFormNewsletterData'>
                                                    <input type="hidden" value="<?php echo ($vo["mainCode"]); ?>" name="delMainCode">
                                                    <a onclick="submit('delform<?php echo ($vo["mainCode"]); ?>','<?php echo ($vo["mainCode"]); ?>')"><i class="fas fa-trash fa-fw icon-size"></i></a>
                                                </form>
                                            </td>
                    ...
                    <form method="post" action='__APP__/NewsletterPreset/setFormNewsletterData'>
                        <div class="modal-body">
                            <div class="form-group row m-b-15">
                                <label class="col-md-4 col-sm-4 col-form-label">簡訊識別碼 :</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" value="" name="setMainCode" id="setMainCode" readonly="">
                                </div>
                            </div>
                            <div class="form-group row m-b-15">
                                <label class="col-md-4 col-sm-4 col-form-label">簡訊內容 :</label>
...
function submit(formId, vo_class) {
    askMsgShow('是否刪除 簡訊識別碼"' + vo_class + '" 的簡訊');
