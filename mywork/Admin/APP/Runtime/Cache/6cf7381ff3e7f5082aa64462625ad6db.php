...
<html>
	...
	<link href="__CSS__/color-admin-v4.2/admin/assets/plugins/ionicons/css/ionicons.min.css" rel="stylesheet" />
	<link href="__CSS__/color-admin-v4.2/admin/assets/plugins/animate/animate.min.css" rel="stylesheet" />
	<link href="__CSS__/color-admin-v4.2/admin/assets/css/apple/style.min.css" rel="stylesheet" />
	<link href="__CSS__/color-admin-v4.2/admin/assets/css/apple/style-responsive.min.css" rel="stylesheet" />
	<link href="__CSS__/color-admin-v4.2/admin/assets/css/default/theme/default.css" rel="stylesheet" id="theme" />
	<!-- ================== END BASE CSS STYLE ================== -->
	<link href="__CSS__/color-admin-v4.2/admin/assets/css/mystyle.css" rel="stylesheet"/>
	<!-- ================== BEGIN BASE JS ================== -->
	<!--<script src="_CSS__/color-admin-v4.2/admin/assets/plugins/pace/pace.min.js"></script>-->
	<!-- ================== END BASE JS ================== -->
</head>
<body class="pace-top">
	...
	<div id="page-container" class="fade">
		<!-- begin error -->
		<div class="error">
			<?php if(isset($error)): ?><div class="error-code m-b-10"><i class="fas fa-lg fa-fw m-r-10 fa-minus-circle" style="color:red"></i></div><?php endif; ?>
			<?php if(isset($message)): ?><div class="error-code m-b-10 text-blue"><i class="fas fa-lg fa-fw m-r-10 fa-check-circle"></i></div><?php endif; ?>
			
			
			<div class="error-content">
				<?php if(isset($error)): ?><div class="error-message" style="color:red"><?php echo ($error); ?></div><?php endif; ?>
		      	<?php if(isset($message)): ?><div class="error-message text-blue"><?php echo ($message); ?></div><?php endif; ?>
				<div>
					<a onclick="javascript:location.href='<?php echo ($jumpUrl); ?>'" class="btn btn-primary p-20 text-white m-t-20 f-s-35">返回</a>
				</div>
			</div>
		</div>
		<!-- end error -->
