                                ...
                                <table id="table1" class="table table-striped m-b-0">
                                    ...
                                    <tbody>
                                        <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "$showEmpty" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <?php if($vo1["belong"] == '前台'): if($vo1["order"] > 1): ?><form class="div-style" id="sortup<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                                <input type="hidden" value="upSort" name="className">
                                                                <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="sortId">
                                                                <input type="hidden" value="<?php echo ($vo1["belong"]); ?>" name="marqueeBelong">
                                                    ...
                                                    <?php if($vo1["belong"] == '代理'): if($vo1["order"] > 1): ?><form class="div-style" id="sortupagent<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                                <input type="hidden" value="upSort" name="className">
                                                                <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="sortId">
                                                                <input type="hidden" value="<?php echo ($vo1["belong"]); ?>" name="marqueeBelong">
                                                                <input type="hidden" value="<?php echo ($vo1["order"]); ?>" name="orderSort">
                                                    ...
                                                    <?php if($vo1["belong"] == '後台'): if($vo1["order"] > 1): ?><form class="div-style" id="sortupback<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                                <input type="hidden" value="upSort" name="className">
                                                                <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="sortId">
                                                                <input type="hidden" value="<?php echo ($vo1["belong"]); ?>" name="marqueeBelong">
                                                                <input type="hidden" value="<?php echo ($vo1["order"]); ?>" name="orderSort">
                                                    ...
                                                    <?php if($vo1["belong"] == '前台'): if($vo1["order"] < $showCount['前台']): ?><form class="div-style" id="sortdownfront<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                    ...
                                                    <?php if($vo1["belong"] == '代理'): if($vo1["order"] < $showCount['代理']): ?><form class="div-style" id="sortdownagent<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                                <input type="hidden" value="downSort" name="className">
                                                                <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="sortId">
                                                                <input type="hidden" value="<?php echo ($vo1["belong"]); ?>" name="marqueeBelong">
                                                                <input type="hidden" value="<?php echo ($vo1["order"]); ?>" name="orderSort">
                                                    ...
                                                    <?php if($vo1["belong"] == '後台'): if($vo1["order"] < $showCount['後台']): ?><form class="div-style" id="sortdownback<?php echo ($vo1["id"]); ?>" method="post" action="__APP__/MarqueeManage/formSortAgentPageClass">
                                                                <input type="hidden" value="downSort" name="className">
                                                                <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="sortId">
                                                                <input type="hidden" value="<?php echo ($vo1["belong"]); ?>" name="marqueeBelong">
                                                                <input type="hidden" value="<?php echo ($vo1["order"]); ?>" name="orderSort">
                                                ...
                                                <td>
                                                    <a onclick="openTextModal('setTextModal','<?php echo ($vo1["textTw"]); ?>','<?php echo ($vo1["textCn"]); ?>','<?php echo ($vo1["textUs"]); ?>','<?php echo ($key+1); ?>')">
                                                ...
                                                <td>
                                                    <a onclick="openmodal('setModal','<?php echo ($vo1["id"]); ?>','<?php echo ($vo1["belong"]); ?>','<?php echo ($vo1["textTw"]); ?>','<?php echo ($vo1["textCn"]); ?>','<?php echo ($vo1["textUs"]); ?>')"><i class="fas fa-wrench fa-fw icon-size"></i></a>
                                                    <?php if($vo1["enabled"] == "啟用中"): ?><form id="formInquireTostop<?php echo ($vo1["id"]); ?>" class="div-style form-vertical-align" method="post" action='__APP__/MarqueeManage/formStopMarquee'>
                                                            <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="stopId">
                                                            <div class="switcher">
                                                                <input type="checkbox" name="switcher_checkbox_<?php echo ($vo1["id"]); ?>" id="switcher_checkbox_<?php echo ($vo1["id"]); ?>" checked onclick="submitAjax('formInquireTostop','<?php echo ($vo1["id"]); ?>','stopId')">
                                                                <label for="switcher_checkbox_<?php echo ($vo1["id"]); ?>" id="<?php echo ($vo1["id"]); ?>_checkbox" class="switchbtn"></label>
                                                            </div>
                                                        </form>
                                                        <?php else: ?>
                                                        <form id="formInquireTostart<?php echo ($vo1["id"]); ?>" class="div-style form-vertical-align" method="post" action='__APP__/MarqueeManage/formStartMarquee'>
                                                            <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="startId">
                                                            <div class="switcher">
                                                                <input type="checkbox" name="switcher_checkbox_<?php echo ($vo1["id"]); ?>" id="switcher_checkbox_<?php echo ($vo1["id"]); ?>" onclick="submitAjax('formInquireTostart','<?php echo ($vo1["id"]); ?>','startId')">
                                                                <label for="switcher_checkbox_<?php echo ($vo1["id"]); ?>" id="<?php echo ($vo1["id"]); ?>_checkbox" class="switchbtn"></label>
                                                            </div>
                                                        </form><?php endif; ?>
                                                    <form id="delform<?php echo ($vo1["id"]); ?>" class="div-style" method="post" action='__APP__/MarqueeManage/formDelMarquee'>
                                                        <input type="hidden" value="<?php echo ($vo1["id"]); ?>" name="delId">
