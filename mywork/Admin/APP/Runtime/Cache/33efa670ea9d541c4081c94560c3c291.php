...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
	...
	<div id="content" class="content">
		...
		<form class="form-inline m-b-10" id="formInquire" method="post" action='__APP__/<?php echo (MODULE_NAME); ?>/<?php echo (ACTION_NAME); ?>'>
        	<input type="hidden" name="s" value="<?php echo (MODULE_NAME); ?>/<?php echo (ACTION_NAME); ?>">
			...
			<div class="row form-inline p-l-7" style="width:100%;">
				...
				<div class="row col-lg-6 col-xl-1 p-r-5 p-l-5 m-r-0 m-l-0 m-b-10">
                  <div class="col-12 p-0">
                   
					<select name="selectClass" class="form-control" style="width:100%;" data-size="10" data-live-search="true" data-style="btn-info">
						<?php if($selectClass == 'Member'): ?><option selected value="Member">會員</option>
						<?php else: ?>
							<option value="Member">會員</option><?php endif; ?>
						<?php if($selectClass == 'Agent'): ?><option selected value="Agent">代理</option>
						<?php else: ?>
							<option value="Agent">代理</option><?php endif; ?>
						<?php if($selectClass == 'Admin'): ?><option selected value="Admin">公司</option>
						<?php else: ?>
							<option value="Admin">公司</option><?php endif; ?>
						<?php if($selectClass == 'all'): ?><option selected value="all">全顯示</option>
						<?php else: ?>
							<option value="all">全顯示</option><?php endif; ?>
					</select>
