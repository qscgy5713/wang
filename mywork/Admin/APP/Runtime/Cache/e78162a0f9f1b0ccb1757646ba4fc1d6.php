                    ...
                    <div class="tab-pane fade active show">
                        <div class="table-responsive">
                            <table id="" class="table table-striped m-b-0">
                                ...
                                <tbody>
                                    <?php if(is_array($showArray)): $i = 0; $__LIST__ = $showArray;if( count($__LIST__)==0 ) : echo "$rechargeEmpty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <?php if($vo["recharge"] == '1'): ?><td><?php echo ($vo["memberAccount"]); ?></td>
                                                <td><?php echo ($vo["rechargeLastCode"]); ?></td>
                                                <td><?php echo ($vo["rechargeArea"]); ?></td>
                                                <td><?php echo ($vo["rechargeRemark"]); ?></td>
                                                <td><?php echo ($vo["rechargeModifyTime"]); ?></td>
                                                <td>
                                                    <a onclick="openmodal('setModal','recharge','<?php echo ($vo["memberAccount"]); ?>','<?php echo ($vo["rechargeLastCode"]); ?>','<?php echo ($vo["rechargeArea"]); ?>','<?php echo ($vo["rechargeRemark"]); ?>')"><i class="fas fa-wrench fa-fw icon-size"></i></a>
