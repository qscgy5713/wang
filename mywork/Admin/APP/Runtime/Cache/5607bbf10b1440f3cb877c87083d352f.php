...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
    ...
    <div id="content" class="content">
        <button type="button" class="btn btn-info m-b-10" onclick="self.location.href='__APP__/<?php echo (MODULE_NAME); ?>/index'">回上一頁</button>
        <form class="form-inline m-b-10" id="formInquire" method="post" action='__APP__/<?php echo (MODULE_NAME); ?>/<?php echo (ACTION_NAME); ?>'>
            ...
            <div class="row form-inline p-l-7" style="width:100%;">
                ...
                <div class="row col-lg-6 col-xl-5 p-r-0 p-l-0 m-r-0 m-l-0 m-b-10">
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="今日" onClick="formTime('<?php echo ($today); ?> 00:00:00','<?php echo ($today); ?> 23:59:59')" />
                    </div>
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="昨日" onClick="formTime('<?php echo ($yesterday); ?> 00:00:00','<?php echo ($yesterday); ?> 23:59:59')" />
                    </div>
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="本週" onClick="formTime('<?php echo ($thisWeekA); ?> 00:00:00','<?php echo ($thisWeekB); ?> 23:59:59')" />
                    </div>
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="上週" onClick="formTime('<?php echo ($lastWeekA); ?> 00:00:00','<?php echo ($lastWeekB); ?> 23:59:59')" />
                    </div>
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="本月" onClick="formTime('<?php echo ($thisMonthA); ?> 00:00:00','<?php echo ($thisMonthB); ?> 23:59:59')" />
                    </div>
                    <div class="col-2 p-r-5 p-l-5">
                        <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd" style="width:100%;" type="button" value="上月" onClick="formTime('<?php echo ($lastMonthA); ?> 00:00:00','<?php echo ($lastMonthB); ?> 23:59:59')" />
                    </div>
                </div>
                <div class="row col-lg-6 col-xl-3 p-r-5 p-l-5 m-r-0 m-l-0 m-b-10">
                    <div class="col-5 p-0">
                        <input id="startTime" name="startTime" type="text" class="form-control div-style" style="width:100%;" value="<?php echo ($startTime); ?>" />
                    </div>
                    <div class="col-2 text-center p-0"><label class="p-5">至</label></div>
                    <div class="col-5 p-0">
                        <input id="endTime" name="endTime" type="text" class="form-control div-style" style="width:100%;" value="<?php echo ($endTime); ?>" />
                    </div>
                </div>
                <div class="row col-lg-12 col-xl-4 p-r-5 p-l-5 m-r-0 m-l-0">
                    <div class="col-3 col-md-2 col-xl-4 text-center p-0"><label class="p-5">搜索帳號:</label></div>
                    <div class="col-9 col-md-7 col-xl-6 p-r-0 p-l-0">
                        <input class="form-control" style="width:100%;" type="text" name="memberAccount" id="member_account" value="<?php echo ($memberAccount); ?>" placeholder="請輸入完整帳號">
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="table2" class="table table-striped m-b-0">
                                ...
                                <tbody>
                                    <?php if(is_array($showArray)): $i = 0; $__LIST__ = $showArray;if( count($__LIST__)==0 ) : echo "$memberEmpty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a onclick="openmodal('replyModal','<?php echo ($vo["id"]); ?>','<?php echo ($vo["memberAccount"]); ?>','<?php echo ($vo["title"]); ?>','<?php echo ($vo["main"]); ?>','<?php echo ($vo["reply"]); ?>')"><i class="fas fa-wrench fa-fw icon-size"></i></a>
                                            </td>
                    ...
                    <form method="post" action='__APP__/ProcessMail/formReplyMailManage'>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <textarea class="form-control" id="reply" rows="10" readonly></textarea>
                                </div>
                            </div>
                        </div>
