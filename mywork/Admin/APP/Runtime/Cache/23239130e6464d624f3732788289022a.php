		...
		<form class="form-inline m-b-10" id="formInquire" method="post" action='__APP__/<?php echo (MODULE_NAME); ?>/<?php echo (ACTION_NAME); ?>'>
			...
			<div class="row form-inline p-l-7" style="width:100%;">
				...
				<div class="row col-lg-12 col-xl-4 p-r-5 p-l-5 m-r-0 m-l-0">
                  ...
                  <!-- <div class="col-3 col-md-2 col-xl-4 text-center p-0 m-b-10"><label class="p-5">搜索帳號:</label>
                  </div>
							...
							<table id="table1" class="table table-striped m-b-0">
								...
								<tbody>
									<?php if(is_array($showArray)): $i = 0; $__LIST__ = $showArray;if( count($__LIST__)==0 ) : echo "$showEmpty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($vo["logCreateTime"]); ?></td>
											<td><?php echo ($vo["logFunction"]); ?></td>
											<td><?php echo ($vo["logSeeion"]); ?></td>
											<td><?php echo ($vo["logData"]); ?></td>
											<td><?php echo ($vo["logResult"]); ?></td>
											<td><?php echo ($vo["logError"]); ?></td>
											<td><?php echo ($vo["logIp"]); ?></td>
											<td><?php echo ($vo["logUrl"]); ?></td>
