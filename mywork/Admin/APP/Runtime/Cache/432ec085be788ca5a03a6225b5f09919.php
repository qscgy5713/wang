...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
	...
	<div id="content" class="content">
		...
		<form class="form-inline m-b-10" method="post" id="formInquire" action='__APP__/<?php echo (MODULE_NAME); ?>/<?php echo (ACTION_NAME); ?>'>
			...
			<div class="row form-inline p-l-7" style="width:100%;">
				...
				<div class="row col-lg-6 col-xl-5 p-r-0 p-l-0 m-r-0 m-l-0 m-b-10">
                  ...
                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="今日" onClick="formTime('<?php echo ($today); ?> 00:00:00','<?php echo ($today); ?> 23:59:59')"/>
                  </div>

                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="昨日" onClick="formTime('<?php echo ($yesterday); ?> 00:00:00','<?php echo ($yesterday); ?> 23:59:59')"/>
                  </div>

                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="本週" onClick="formTime('<?php echo ($thisWeekA); ?> 00:00:00','<?php echo ($thisWeekB); ?> 23:59:59')"/>
                  </div>

                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="上週" onClick="formTime('<?php echo ($lastWeekA); ?> 00:00:00','<?php echo ($lastWeekB); ?> 23:59:59')"/>
                  </div>

                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="本月" onClick="formTime('<?php echo ($thisMonthA); ?> 00:00:00','<?php echo ($thisMonthB); ?> 23:59:59')"/>
                  </div>

                  <div class="col-2 p-r-5 p-l-5">
                    <input class="btn btn-info p-r-0 p-l-0 f-s-13 time-btn-rwd chkDate" style="width:100%;" type="button" value="上月" onClick="formTime('<?php echo ($lastMonthA); ?> 00:00:00','<?php echo ($lastMonthB); ?> 23:59:59')"/>
                  </div>
				...
				<div class="row col-lg-12 col-xl-4 p-r-5 p-l-5 m-r-0 m-l-0">
                  ...
                  <div class="col-9 col-md-7 col-xl-6 p-r-0 p-l-0 m-b-10">
                    <input class="form-control" style="width:100%;" type="text" name="memberAccount" id="member_account" value="<?php echo ($memberAccount); ?>" placeholder="請輸入帳號">
                  </div>
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<?php if($pageNumber != ''): ?><div class="row m-t-10">
					                  <div class="main col-lg-12">
					                  		<nav aria-label="Page navigation">
								                ...
								                <?php if($pageNumber-1 != 0): ?><li id="" class="page-item"><a class="page-link" href="#" onClick="goPage('1')">第一頁</a></li>
								                  ...
								                  <?php if($pageNumber+1 <= $totalPage ): ?><li id="<?php echo ($totalPage); ?>Page" class="page-item"><a class="page-link" href="#" onClick="goPage('<?php echo ($totalPage); ?>')">...<?php echo ($totalPage); ?></a></li>
									                  <li class="page-item">
